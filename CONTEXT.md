...
headline Cost, tokens, Requests, pace against the window before it, tokens (or,
by the reader's choice, Cost) per bucket across the window, per-Source and
per-Model figures, Cache Hit Rate,
