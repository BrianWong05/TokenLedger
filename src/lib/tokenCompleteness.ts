...
// Unbooked Requests (TOKL-25) are deliberately NOT a completeness rule here.
// They are stated — the scan footer and the CSV report carry the per-Source
// counts — but they qualify no figure and mark nothing with ≥. The floor ran
// for one release and read as noise. Mirror of the note in
// src-tauri/src/readout.rs.
